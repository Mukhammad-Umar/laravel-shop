			...
			<div class="col-md-4 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						...
						<ul class="slides">
							<li data-thumb="{{ asset('public/images/' . $product->image)}}">
								<div class="thumb-image"> <img src="{{ asset('public/images/' . $product->image)}}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="{{ asset('public/images/' . $product->image)}}">
								<div class="thumb-image"> <img src="{{ asset('public/images/' . $product->image)}}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
			...
			<div class="col-md-8 single-right-left simpleCart_shelfItem">
				...
				<div class="occasion-cart">
					<div class="shoe single-item single_page_b">
						<form name="form_tocart" action="{{ route('tocart')}}" method="post">
									{{ csrf_field() }}
			...
			<div class="new_arrivals">
					...
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							<div class="men-thumb-item">
								<img src="{{ asset('public/images/s4.jpg')}}" alt="">
				...
				<div class="col-md-3 product-men women_two">
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							<div class="men-thumb-item">
								<img src="{{ asset('public/images/s5.jpg')}}" alt="">
								<div class="men-cart-pro">
									<div class="inner-men-cart-pro">
										<a href="" class="link-product-add-cart">Quick View</a>
									</div>
				...
				<div class="col-md-3 product-men women_two">
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							<div class="men-thumb-item">
								<img src="{{ asset('public/images/s7.jpg')}}" alt="">
								<div class="men-cart-pro">
									<div class="inner-men-cart-pro">
										<a href="" class="link-product-add-cart">Quick View</a>
									</div>
				...
				<div class="col-md-3 product-men women_two">
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							<div class="men-thumb-item">
								<img src="{{ asset('public/images/s8.jpg')}}" alt="">
								<div class="men-cart-pro">
									<div class="inner-men-cart-pro">
										<a href="" class="link-product-add-cart">Quick View</a>
									</div>
