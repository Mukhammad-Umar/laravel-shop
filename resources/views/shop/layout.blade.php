...
<body>
		...
		<div class="wrapper_top_w3layouts">
			<div class="header_agileits">
				<div class="logo inner_page_log">
					<h1><a class="navbar-brand" href="{{ route('index')}}"><span>Downy</span> <i>Shoes</i></a></h1>
				</div>
	...
	<div class="footer_agileinfo_w3 text-center">
		<div class="footer_inner_info_w3ls_agileits">
			<div class="col-md-3 footer-left">
				<h2><a href="{{ route('index')}}"><span>D</span>owny Shoes </a></h2>
	...
	<!-- credit-card -->
	<script type="text/javascript" src="{{ asset('public/js/creditly.js')}}"></script>
	<link rel="stylesheet" href="{{ asset('public/css/creditly.css')}}" type="text/css" media="all" />
