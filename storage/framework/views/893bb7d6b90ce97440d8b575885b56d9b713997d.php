							...
							<div class="tab4">
								<div class="pay_info">
									<div class="col-md-6 tab-grid">
										<img class="pp-img" src="<?php echo e(asset('public/images/paypal.png')); ?>" alt="Image Alternative text" title="Image Title">
...
<?php echo $__env->make('shop.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-shop/resources/views/shop/payment.blade.php ENDPATH**/ ?>